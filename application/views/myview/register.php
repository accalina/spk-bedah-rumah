            ...
            <div class="row">
                <div class="col-lg">
                    <div class="p-5">
                        ...
                        <form class="user" method="post" action="<?= base_url('index.php/server/register_engine'); ?>">
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="name" name="name" placeholder="Full Name" required autofocus>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="text-center">
                            <a class="small" href="<?= base_url('index.php/server/login'); ?>">Already have an account? Login!</a>
                        </div>
                    </div>
                </div>
            </div>
